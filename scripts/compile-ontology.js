...
const ttlPath = path.resolve('src/plugins/archimate/ontology.ttl');
const outputPath = path.resolve('src/plugins/archimate/ontology.json');
...
const NS = 'http://www.semanticweb.org/v0cn037/ontologies/2024/11/archimate32#';
