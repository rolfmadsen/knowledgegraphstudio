---
type: User Guide
title: 'UI Zones & Keyboard Navigation Guide'
description: 'Comprehensive guide to 4 screen zones, spatial walking, Command Hub, and keyboard navigation shortcuts.'
status: stable
tags:
- architecture
- notation
