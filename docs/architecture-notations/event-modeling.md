...
title: 'Event Modeling Layout & Interaction Guide'
description: 'Swimlane structure, slice boundaries, command-event-readmodel flows, and spatial toolbar actions.'
status: stable
tags:
- architecture
- notation
