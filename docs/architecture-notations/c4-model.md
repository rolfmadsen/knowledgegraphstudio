...
title: 'C4 Model Metamodel & Ontology Specification'
description: 'Hierarchical software architecture abstractions (Context, Container, Component, Code) and boundaries.'
status: stable
tags:
- architecture
- notation
