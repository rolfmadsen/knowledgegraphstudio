...
title: 'Cross-Notation ConceptType Mapping Matrix'
description: 'Exhaustive mapping between underlying semantic ConceptType nodes and notation-specific visual stereotypes.'
status: stable
tags:
- architecture
- notation
