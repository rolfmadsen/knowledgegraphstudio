...
Instead of compiling and running a heavy RDF reasoner in the browser client, the validation engine resolves the transitive closures of the compiled JSON ontologies and executes rules in a reactive hook [useValidation.ts](file:///home/rolfmadsen/Github/knowledgegraphstudio/src/features/validation/useValidation.ts).
