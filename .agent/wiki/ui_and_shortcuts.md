...
Dette dokument beskriver opbygningen af TypeGraphs brugerflade, tastaturgenveje samt integrationen af Monaco Editor.

## Skærmzoner (Zone 1-4)

Brugerfladen i TypeGraph er opdelt i fire definerede zoner for at understøtte en struktureret og datatæt arbejdsgang:
...
TypeGraph er designet til at kunne betjenes 100% fra tastaturet. Genvejene er kontekstafhængige:
...
*   **Esc-Trap og Focus Escape:**
    ...
    *   TypeGraph implementerer en specifik keydown listener (`useKeyboard.ts`). Når Monaco er fokuseret, vil et tryk på `Esc` tvinge editoren til at slippe fokus og returnere det til det visuelle lærred eller Zone 1.
